...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 5772.923392285877; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -5963.28939432823; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 599.0106695600905; // x position of the perpendicular encoder (in tick units)
    }
